...
*gitall* - runs Git command recursively for all subfolders which are Git repositories.

*recursive-run* - run commands recursively substituting all ${} placeholders for one value at a time
